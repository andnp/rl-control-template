...
from experiment.OptunaExperiment import ExperimentModel
...
if __name__ == "__main__":
    ...
    hyper_cols = set[str]()
    for res in results:
        hyper_cols |= res.exp.get_hyper_names()
    ...
    for env, env_df in split_over_column(df, col='environment'):
        ...
        for alg, sub_df in split_over_column(env_df, col='algorithm'):
            ...
            xs, ys = extract_multiple_learning_curves(
                ...
                metric='return',
                interpolation=lambda x, y: compute_step_return(x, y, exp.evaluation_steps),
            )
